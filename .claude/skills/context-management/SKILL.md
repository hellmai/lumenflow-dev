...
2. **Wave manifests for idempotency** — `._legacy/artifacts/waves/INIT-XXX-wave-N.json`
3. **Stamp-based completion** — Check `._legacy/stamps/WU-*.done` for progress
...
- **v1.3.0** (2026-01-26): Added pre-clear checkpoint hook guidance
