...
Write({
  file_path: '/home/USER/source/{ORG}/{PROJECT_REPO}/{PROJECT_ROOT}/web/src/lib/validator.ts', // Writes to MAIN, not worktree!
  content: '...',
});
```
...
pwd
# Should output: /home/USER/source/{ORG}/{PROJECT_REPO}/worktrees/operations-wu-427
