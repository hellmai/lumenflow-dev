...
| ---------------------------------------------- | ---------- | -------- | --------- | ----- | ---------------------------------------------------- |
| Application (`@patientpath/application`)       | ≥90%       | ≥90%     | ≥90%      | ≥90%  | Business logic MUST be comprehensively tested (§2.3) |
| Infrastructure (`@patientpath/infrastructure`) | ≥80%       | ≥80%     | ≥80%      | ≥80%  | Adapters require thorough integration tests (§6.4.4) |
...
4. **Audit Trail**: Coverage artifacts downloadable from Actions tab for compliance evidence (NHS DTAC)
...
PatientPath provides these skills in `.claude/skills/`:
