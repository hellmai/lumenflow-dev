...
> **Agents:** Start with [Starting Prompt](docs/04-operations/_frameworks/lumenflow/agent/onboarding/starting-prompt.md) for onboarding.
...
- [WU-1004 — Make gates script repo-agnostic (skip missing apps/web) (cancelled)](wu/WU-1004.yaml) — CLI
- [WU-1066 — Add .NET/C# preset to lumenflow-gates GitHub Action (cancelled)](wu/WU-1066.yaml) — Operations: CI/CD
- [WU-1098 — 'BUG: Fix Starlight docs formatting issues' (cancelled)](wu/WU-1098.yaml) — Content: Documentation
- [WU-1129 — Fix pre-existing prettier format failures in apps/docs/\*.mdx (cancelled)](wu/WU-1129.yaml) — Content: Documentation
- [WU-1143 — Fix backlog-sync gate - WU files missing from backlog.md (cancelled)](wu/WU-1143.yaml) — Operations: Infrastructure
- [WU-1146 — Regenerate backlog.md from wu-events.jsonl to fix sync (cancelled)](wu/WU-1146.yaml) — Operations: Infrastructure
...
- [WU-1018 — Migrate missing CLI commands from  to @lumenflow/cli](wu/WU-1018.yaml) — CLI
...
- [WU-1068 — LumenFlow Framework Cleanup - Remove  leakage and fix code smells](wu/WU-1068.yaml) — Framework: Core
...
- [WU-1079 — Migrate stamps from ._legacy to .lumenflow](wu/WU-1079.yaml) — Framework: Core
