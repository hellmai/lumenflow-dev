...
- [WU-1578 — Formalize client integration contract/constants for vendor-agnostic init](wu/WU-1578.yaml) — Framework: CLI Enforcement
...
- [WU-1576 — Fold integrate into init for bomb-proof onboarding](wu/WU-1576.yaml) — Framework: CLI Enforcement
- [WU-1577 — Prevent wu:done rollback leaks on main during merge failure](wu/WU-1577.yaml) — Framework: Core Lifecycle
...
- [WU-1421 — Rename ._legacy to .lumenflow (complete  migration)](wu/WU-1421.yaml)
