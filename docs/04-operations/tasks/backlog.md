...
- [WU-1063 — Add stamp expiry and refresh mechanism](wu/WU-1063.yaml)
- [WU-1066 — Add wu:spawn mode for remote Claude sessions](wu/WU-1066.yaml)
- [WU-1073 — Design TDD progression scoring](wu/WU-1073.yaml)
- [WU-1098 — INIT-003: Migrate tools to @lumenflow packages](wu/WU-1098.yaml)
- [WU-1129 — P2: Fix guard commands failing in worktree context](wu/WU-1129.yaml)
- [WU-1134 — P3: Improve wu:spawn reliability for web agents](wu/WU-1134.yaml)
- [WU-1135 — P3: Add checkpoint recovery guidance to spawn prompts](wu/WU-1135.yaml)
- [WU-1143 — P3: Add validation for WU acceptance criteria completeness](wu/WU-1143.yaml)
...
- [WU-1007 — Add multi-repo support](wu/WU-1007.yaml)
