...
- [WU-1075 — Rename .beacon to .lumenflow - remove PatientPath branding](wu/WU-1075.yaml) — 2026-01-23
...
- [WU-1018 — Migrate missing CLI commands from PatientPath to @lumenflow/cli](wu/WU-1018.yaml) — 2026-01-19
...
- [WU-1068 — LumenFlow Framework Cleanup - Remove PatientPath leakage and fix code smells](wu/WU-1068.yaml) — 2026-01-23
...
- [WU-1052 — Migrate remaining tests from PatientPath tools/ to hellmai/os packages](wu/WU-1052.yaml) — 2026-01-22
