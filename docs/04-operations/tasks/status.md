...
- [WU-2253 — macOS sandbox posture-aware network rules](wu/WU-2253.yaml) — 2026-02-27
...
- [WU-2279 — Fix state:doctor --fix invalid temp branch name](wu/WU-2279.yaml) — 2026-02-28
...
- [WU-2294 — Fix doc parity: stale commands, broken links, missing steps across all consumer-facing docs](wu/WU-2294.yaml) — 2026-03-02
