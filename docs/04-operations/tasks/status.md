...
- [WU-1702 — Emergency: remove domain-specific code from CLI and MCP packages](wu/WU-1702.yaml) — Stale emergency WU; unblock wu:claim overlap scanner symlink-loop
