...
# Derived metadata for lane suggestion/classification only.
# Source of truth for lane validation: workspace.yaml (software_delivery.lanes.definitions)
# Regenerate after lane definition changes:
...
function showSaveInstructions(): void {
  ...
  console.log(chalk.gray('  # workspace.yaml remains the source of truth for lane validation'));
}
