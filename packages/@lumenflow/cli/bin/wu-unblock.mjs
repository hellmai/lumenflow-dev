...
import { checkLaneFree } from '@lumenflow/core/lib/lane-checker.mjs';
...
import { WU_PATHS, defaultWorktreeFrom } from '@lumenflow/core/lib/wu-paths.mjs';
import { readWU, writeWU, appendNote } from '@lumenflow/core/lib/wu-yaml.mjs';
import {
  STATUS_SECTIONS,
  PATTERNS,
  LOG_PREFIX,
...
import { defaultBranchFrom } from '@lumenflow/core/lib/wu-done-validators.mjs';
import { ensureOnMain } from '@lumenflow/core/lib/wu-helpers.mjs';
import { emitWUFlowEvent } from '@lumenflow/core/lib/telemetry.mjs';
import { ensureStaged } from '@lumenflow/core/lib/git-staged-validator.mjs';
  ...
  if (!args.noAuto) {
    ...
    await withMicroWorktree({
      ...
      execute: async ({ worktreePath }) => {
        ...
        const stateDir = path.join(worktreePath, '._legacy', 'state');
