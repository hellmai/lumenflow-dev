...
import { isOrphanWorktree } from '@lumenflow/core/lib/orphan-detector.mjs';
// WU-1352: Use centralized YAML functions from wu-yaml.mjs
import { parseYAML, stringifyYAML } from '@lumenflow/core/lib/wu-yaml.mjs';
import { assertTransition } from '@lumenflow/core/lib/state-machine.mjs';
import { checkLaneFree, validateLaneFormat } from '@lumenflow/core/lib/lane-checker.mjs';
...
} from '@lumenflow/core/lib/lane-lock.mjs';
// WU-1825: Import from unified code-path-validator (consolidates 3 validators)
import { validateLaneCodePaths, logLaneValidationWarnings } from '@lumenflow/core/lib/code-path-validator.mjs';
// WU-1574: parseBacklogFrontmatter/getSectionHeadings removed - state store replaces backlog parsing
import { detectConflicts } from '@lumenflow/core/lib/code-paths-overlap.mjs';
import { getGitForCwd, createGitForPath } from '@lumenflow/core/lib/git-adapter.mjs';
import { die } from '@lumenflow/core/lib/error-handler.mjs';
import { createWUParser, WU_OPTIONS } from '@lumenflow/core/lib/arg-parser.mjs';
import { WU_PATHS, getStateStoreDirFromBacklog } from '@lumenflow/core/lib/wu-paths.mjs';
import {
  BRANCHES,
  REMOTES,
  WU_STATUS,
...
import { withMicroWorktree } from '@lumenflow/core/lib/micro-worktree.mjs';
import { ensureOnMain } from '@lumenflow/core/lib/wu-helpers.mjs';
import { emitWUFlowEvent } from '@lumenflow/core/lib/telemetry.mjs';
import { checkLaneForOrphanDoneWU, repairWUInconsistency } from '@lumenflow/core/lib/wu-consistency-checker.mjs';
import { emitMandatoryAgentAdvisory } from '@lumenflow/core/lib/orchestration-advisory-loader.mjs';
import { validateWU, generateAutoApproval } from '@lumenflow/core/lib/wu-schema.mjs';
import { startSessionForWU } from '@lumenflow/agent/lib/auto-session-integration.mjs';
import {
  detectFixableIssues,
  applyFixes,
  autoFixWUYaml,
  formatIssues,
} from '@lumenflow/core/lib/wu-yaml-fixer.mjs';
import { validateSpecCompleteness } from '@lumenflow/core/lib/wu-done-validators.mjs';
import { getAssignedEmail } from '@lumenflow/core/lib/wu-claim-helpers.mjs';
import { symlinkNodeModules, symlinkNestedNodeModules } from '@lumenflow/core/lib/worktree-symlink.mjs';
...
import { generateBacklog, generateStatus } from '@lumenflow/core/lib/backlog-generator.mjs';
...
} from '@lumenflow/core/lib/wu-claim-resume.mjs';
...
export function getWorktreeCommitFiles(wuId) {
  return [
    ...
    '._legacy/state/wu-events.jsonl', // WU-1740: Event store is source of truth
      ...
      execute: async ({ worktreePath }) => {
        ...
        return {
          ...
          files: [
            WU_PATHS.BACKLOG(),
            WU_PATHS.STATUS(),
            `._legacy/stamps/${orphanId}.done`,
            '._legacy/state/wu-events.jsonl',
          ],
        };
      },
    });
