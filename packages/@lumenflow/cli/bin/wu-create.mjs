...
import { stringifyYAML } from '@lumenflow/core/lib/wu-yaml.mjs';
// WU-1428: Use date-utils for consistent YYYY-MM-DD format (library-first)
import { todayISO } from '@lumenflow/core/lib/date-utils.mjs';
import { validateLaneFormat, extractParent } from '@lumenflow/core/lib/lane-checker.mjs';
// WU-2330: Import lane inference for sub-lane suggestions
import { inferSubLane } from '@lumenflow/core/lib/lane-inference.mjs';
import { parseBacklogFrontmatter } from '@lumenflow/core/lib/backlog-parser.mjs';
...
import { PLACEHOLDER_SENTINEL, validateReadyWU } from '@lumenflow/core/lib/wu-schema.mjs';
import { COMMIT_FORMATS, FILE_SYSTEM, STRING_LITERALS, READINESS_UI } from '@lumenflow/core/lib/wu-constants.mjs';
// WU-1593: Use centralized validateWUIDFormat (DRY)
import { ensureOnMain, validateWUIDFormat } from '@lumenflow/core/lib/wu-helpers.mjs';
...
function createWUYamlInWorktree(worktreePath, id, lane, title, priority, type, opts = {}) {
  ...
  const wuContent = {
    ...
    code_paths,
    tests,
    artifacts: [`._legacy/stamps/${id}.done`],
    dependencies: [],
    risks: [],
    notes: '',
