 ...
 * - High-risk WUs (auth, PII, RLS, migrations): run integration tests
...
import { emitGateEvent, getCurrentWU, getCurrentLane } from '@lumenflow/core/lib/telemetry.mjs';
import { die } from '@lumenflow/core/lib/error-handler.mjs';
import { getChangedLintableFiles, convertToPackageRelativePaths } from '@lumenflow/core/lib/incremental-lint.mjs';
import { buildVitestChangedArgs, isCodeFilePath } from '@lumenflow/core/lib/incremental-test.mjs';
import { getGitForCwd } from '@lumenflow/core/lib/git-adapter.mjs';
import { runCoverageGate, COVERAGE_GATE_MODES } from '@lumenflow/core/lib/coverage-gate.mjs';
import {
  buildGatesLogPath,
  shouldUseGatesAgentMode,
  updateGatesLatestSymlink,
} from '@lumenflow/core/lib/gates-agent-mode.mjs';
...
import { detectRiskTier, RISK_TIERS, SAFETY_CRITICAL_TEST_PATTERNS } from '@lumenflow/core/lib/risk-detector.mjs';
// WU-2252: Import invariants runner for first-check validation
import { runInvariants } from '@lumenflow/core/lib/invariants-runner.mjs';
 ...
 * Includes: PII, escalation, privacy, red-flag, constitutional enforcer tests
 *
 ...
 * Only runs when auth, PII, RLS, or migration files are modified.
 *
 * @param {object} options - Options
 * @param {object} [options.agentLog] - Agent log context
