...
import { BRANCHES, EXIT_CODES, FILE_SYSTEM, REMOTES, GIT_REFS } from '@lumenflow/core/lib/wu-constants.mjs';
// WU-2278: Import ownership validation for cross-agent protection
import { validateWorktreeOwnership } from '@lumenflow/core/lib/worktree-ownership.mjs';
