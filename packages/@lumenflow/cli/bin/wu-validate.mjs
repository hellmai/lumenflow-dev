...
import { validateWU, validateWUCompleteness } from '@lumenflow/core/lib/wu-schema.mjs';
import { FILE_SYSTEM, EMOJI, PATTERNS } from '@lumenflow/core/lib/wu-constants.mjs';
// WU-2253: Import WU spec linter for acceptance/code_paths validation
import { lintWUSpec } from '@lumenflow/core/lib/wu-lint.mjs';
