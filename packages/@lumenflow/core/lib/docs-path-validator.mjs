 ...
 * - ._legacy/stamps/**
 * - ._legacy/state/wu-events.jsonl (tooling-managed metadata)
 *
 * Forbidden paths:
 * - apps/**
...
import { LUMENFLOW_PATHS, DIRECTORIES, FILE_EXTENSIONS, STRING_LITERALS } from './wu-constants.mjs';
...
export function getAllowedPathsDescription() {
  ...
  - *.md (markdown files)
  - ._legacy/stamps/** (completion stamps)
  - ._legacy/state/${WU_EVENTS_FILE_NAME} (WU lifecycle event log)
