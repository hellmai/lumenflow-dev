 ...
 * @param {string} filename - Migration filename (e.g., '20251224125733_documents_storage.sql')
 ...
 * @param {string} migrationName - Full migration name (e.g., '20251224125733_documents_storage')
