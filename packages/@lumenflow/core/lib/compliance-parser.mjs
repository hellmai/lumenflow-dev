 ...
 *
 * @module tools/lib/compliance-checker
 */

/** @typedef {'ISO27001' | 'regulatory authority_compliance' | 'regulatory authority_DSPT' | 'GDPR' | 'FDA'} ComplianceFramework */
...
/** @typedef {'phase_1_critical_blockers' | 'phase_2_procurement_ready' | 'phase_3_enterprise_ready'} CompliancePhase */
...
export const COMPLIANCE_FRAMEWORKS = ['ISO27001', 'regulatory authority_compliance', 'regulatory authority_DSPT', 'GDPR', 'FDA'];
...
const PHASE_HEADER_MAP = {
  ...
  'Phase 2': 'phase_2_procurement_ready',
...
const FRAMEWORK_KEYWORDS = {
  ...
  regulatory authority_compliance: ['regulatory standard', 'compliance'],
  regulatory authority_DSPT: ['regulatory authority DSPT', 'DSPT'],
  ...
  _getPhaseTargetDate(phase) {
    switch (phase) {
      case 'phase_1_critical_blockers':
        return 'Month 3';
      case 'phase_2_procurement_ready':
        return 'Month 6';
