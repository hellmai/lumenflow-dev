...
describe('worktree-symlink', () => {
  ...
  describe('NESTED_PACKAGE_PATHS', () => {
    ...
    it('should contain all expected packages and apps', () => {
      ...
      // Packages - @/*
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@/prompts');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@/shared');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@/application');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@/ports');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@/infrastructure');
      // Packages - @lumenflow/*
      ...
      expect(NESTED_PACKAGE_PATHS).toContain('packages/legacy-explainer');
      // Apps
