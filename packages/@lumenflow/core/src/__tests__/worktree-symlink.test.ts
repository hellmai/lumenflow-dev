...
describe('worktree-symlink', () => {
  ...
  describe('NESTED_PACKAGE_PATHS', () => {
    ...
    it('should contain all expected packages and apps', () => {
      ...
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@patientpath/prompts'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@patientpath/shared'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@patientpath/application'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@patientpath/ports'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@patientpath/infrastructure'));
      // Packages - @lumenflow/*
  ...
  describe('symlinkNestedNodeModules (WU-1579)', () => {
    ...
    it('should use correct relative path from worktree to main repo', () => {
      ...
      const testPkgPath = 'packages/@patientpath/prompts';
