...
describe('worktree-symlink', () => {
  ...
  describe('NESTED_PACKAGE_PATHS', () => {
    ...
    it('should contain all expected packages and apps', () => {
      ...
      // Packages - @/*
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@/prompts'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@/shared'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@/application'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@/ports'));
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/@/infrastructure'));
      // Packages - @lumenflow/*
      ...
      assert.ok(NESTED_PACKAGE_PATHS.includes('packages/legacy-explainer'));
      // Apps
  ...
  describe('symlinkNestedNodeModules (WU-1579)', () => {
    ...
    it('should use correct relative path from worktree to main repo', () => {
      ...
      const testPkgPath = 'packages/@/prompts';
