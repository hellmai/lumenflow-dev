...
describe('worktree-symlink', () => {
  ...
  describe('NESTED_PACKAGE_PATHS', () => {
    ...
    it('should contain all expected packages and apps', () => {
      ...
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@patientpath/prompts');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@patientpath/shared');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@patientpath/application');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@patientpath/ports');
      expect(NESTED_PACKAGE_PATHS).toContain('packages/@patientpath/infrastructure');
      // Packages - @lumenflow/*
