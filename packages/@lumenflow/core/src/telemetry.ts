 ...
 * @param {string} data.classification_type - Type of classification (e.g., 'mode_detection', 'red_flag', 'sensitive_detection')
...
/**
 * Emit WU flow telemetry event to ._legacy/flow.log
 *
