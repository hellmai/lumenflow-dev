 ...
 * - ._legacy/commands.log (git command audit trail)
 * - ._legacy/flow.log (WU flow events)
...
export const LOG_SOURCES = [
  ...
  { path: '._legacy/commands.log', source: 'commands.log' },
  { path: '._legacy/flow.log', source: 'flow.log' },
