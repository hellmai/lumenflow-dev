 ...
 * 3. Run ALL validations FIRST (before file writes)
...
export async function executeWorktreeCompletion(
  ...
  // This ensures NO files are modified if validation fails
  ...
  try {
    ...
    // WU-1369: Atomic collection - all changes gathered before file writes
    // ======================================================================
