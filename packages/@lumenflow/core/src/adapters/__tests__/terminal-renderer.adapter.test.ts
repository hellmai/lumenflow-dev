  ...
  describe('render()', () => {
    it('should render all 5 sections for complete dashboard data', () => {
      const mockData: DashboardData = {
        ...
        agentMetrics: {
          ...
          'legacy-guardian': createMockAgentMetric('pending'),
        },
      ...
      expect(output).toContain('legacy-guardian');
    ...
    it('should use semantic colours via picocolors (not raw ANSI)', () => {
      const mockData: DashboardData = {
        ...
        agentMetrics: {
          'security-auditor': createMockAgentMetric('pass'),
          'legacy-guardian': createMockAgentMetric('fail'),
        },
        wuProgress: [],
        timeline: [],
        alerts: [
    ...
    it('should be scannable within 5 seconds (compact layout)', () => {
      const mockData: DashboardData = {
        ...
        agentMetrics: {
          'security-auditor': createMockAgentMetric('pass'),
          'legacy-guardian': createMockAgentMetric('pass'),
      ...
      const mockData: DashboardData = {
        ...
        wuProgress: [
          ...
          },
          {
            ...
            headline: 'Awaiting legacy-guardian review',
          },
        ],
        timeline: [
          {
