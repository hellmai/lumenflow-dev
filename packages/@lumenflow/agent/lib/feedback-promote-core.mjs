 ...
 */
export const DRAFT_DIRECTORY = '._legacy/feedback-drafts';

/**
 * Path to feedback index (incident-to-WU mappings)
 */
export const FEEDBACK_INDEX_PATH = '._legacy/feedback-index.ndjson';
...
/**
 * Load all draft files from ._legacy/feedback-drafts/
 *
 * @param {string} baseDir - Base directory
