...
<Aside type="note" title="Software Delivery Pack workflow">
  This end-to-end guide uses the [Software Delivery Pack](/pack/overview). Every command shown
  routes through the LumenFlow [kernel](/concepts/kernel) for scope enforcement, policy evaluation,
