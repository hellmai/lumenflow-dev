...
The repo's authoritative agent workflow docs live here:

- [LumenFlow Playbook](https://github.com/hellmai/os/blob/main/docs/04-operations/_frameworks/lumenflow/playbook.md)
- [Agent Onboarding](https://github.com/hellmai/os/blob/main/docs/04-operations/_frameworks/lumenflow/agent/onboarding/)
