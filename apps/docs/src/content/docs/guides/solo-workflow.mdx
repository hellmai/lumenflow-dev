...
<Aside type="note" title="Software Delivery Pack workflow">
  This guide covers solo development using the [Software Delivery Pack](/pack/overview). All WU and
  gate commands are pack tools governed by the [kernel](/concepts/kernel).
</Aside>
