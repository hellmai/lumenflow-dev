...
- `.beacon/safety-blocks.log` – Blocked safety violations
- `.beacon/force-bypasses.log` – Emergency LUMENFLOW_FORCE bypasses
...
<Aside type="caution">
  ...
  using LUMENFLOW_FORCE. All bypasses are logged to `.beacon/force-bypasses.log`.
</Aside>
