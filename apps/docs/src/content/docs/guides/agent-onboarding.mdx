...
<Aside type="note" title="Software Delivery Pack onboarding">
  This guide covers agent onboarding for the [Software Delivery Pack](/pack/overview). The
  commands, safety mechanisms, and WU lifecycle described here are pack-specific tools that operate
  through the [kernel](/concepts/kernel).
</Aside>
