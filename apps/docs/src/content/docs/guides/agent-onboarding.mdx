...
| Absolute path scanning | Blocks `/home/`, `/Users/` paths in code          |
...
- `._legacy/safety-blocks.log` – Blocked safety violations
- `._legacy/force-bypasses.log` – Emergency LUMENFLOW_FORCE bypasses
...
<Aside type="caution">
  ...
  using LUMENFLOW_FORCE. All bypasses are logged to `._legacy/force-bypasses.log`.
</Aside>
