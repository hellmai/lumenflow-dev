---
title: Constraints
description: The 6 non-negotiable rules of the Software Delivery Pack
---

import { Aside, Card, CardGrid, Steps } from '@astrojs/starlight/components';

<Aside type="note" title="Software Delivery Pack constraints">
  These constraints are defined by the [Software Delivery Pack](/packs/software-delivery/overview). They govern
  software delivery workflows specifically. The [kernel](/kernel/runtime) provides the underlying
  enforcement mechanisms (scope intersection, policy engine, evidence recording) that make these
  constraints inescapable. Other [packs](/kernel/packs) define their own domain-specific
  constraints.
</Aside>
...
- [Agent Onboarding](/packs/software-delivery/agents/agent-onboarding) - Get productive quickly
- [Gates](/packs/software-delivery/concepts/gates) - Quality enforcement
- [Troubleshooting](/packs/software-delivery/setup/troubleshooting) - When things go wrong
