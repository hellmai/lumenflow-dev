...
1. Open an issue on [hellmai/lumenflow](https://github.com/hellmai/lumenflow-dev/issues)
...
This bypasses all worktree checks. See [AI Agent Integration](/packs/software-delivery/agents/ai-agent-integration#headless-mode-for-cicd) for details.
