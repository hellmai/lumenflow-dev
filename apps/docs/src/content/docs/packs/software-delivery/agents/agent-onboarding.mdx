...
<Aside type="note" title="Software Delivery Pack onboarding">
  This guide covers agent onboarding for the [Software Delivery Pack](/packs/software-delivery/overview). The commands,
  safety mechanisms, and WU lifecycle described here are pack-specific tools that operate through
  the [kernel](/kernel/runtime).
</Aside>
...
### Web Runtime Setup (Dashboard + AG-UI)
...
- [AI Agent Integration](/packs/software-delivery/agents/ai-agent-integration) - Full agent capabilities
- [Constraints](/packs/software-delivery/concepts/constraints) - The 6 non-negotiable rules
- [Troubleshooting](/packs/software-delivery/setup/troubleshooting) - Common issue fixes
- [Memory Layer](/packs/software-delivery/concepts/memory) - Context recovery
