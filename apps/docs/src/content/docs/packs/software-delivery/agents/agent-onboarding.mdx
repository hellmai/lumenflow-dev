...
<Aside type="note" title="Software Delivery Pack onboarding">
  ...
  Pack](/packs/software-delivery/overview). The commands, safety mechanisms, and WU lifecycle
  described here are pack-specific tools that operate through the [kernel](/kernel/runtime).
</Aside>
