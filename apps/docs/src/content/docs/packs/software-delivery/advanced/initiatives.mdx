...
<Aside type="tip">
  Checkpoint mode is auto-enabled for initiatives with more than 3 WUs or more than 2 waves. You
  can always pass `-c` explicitly for smaller initiatives if you prefer the wave-by-wave approach.
</Aside>
