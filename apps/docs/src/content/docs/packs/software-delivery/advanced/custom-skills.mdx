...
- Read the [Skills section](/packs/software-delivery/agents/ai-agent-integration#skills) for built-in skills
- Learn about [Agent Integration](/packs/software-delivery/agents/ai-agent-integration) for full agent workflows
