...
<Aside type="note" title="Software Delivery Pack workflow">
  This guide covers team workflows using the [Software Delivery Pack](/packs/software-delivery/overview). Lane
  strategies, claiming protocols, and WIP enforcement are pack concepts enforced by the
