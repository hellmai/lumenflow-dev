...
<Aside type="note" title="Software Delivery Pack workflow">
  This walkthrough uses the [Software Delivery Pack](/packs/software-delivery/overview) — LumenFlow's built-in pack for
  software development. The CLI commands (`wu:claim`, `wu:prep`, `wu:done`, `gates`) and concepts
  (WUs, lanes, worktrees) are all pack-provided tools that route through the
  [kernel](/kernel/runtime) for governance.
</Aside>
...
- [Solo Developer Workflow](/packs/software-delivery/workflows/solo-workflow) - Simplified flow for individual work
- [Team Workflow](/packs/software-delivery/workflows/team-workflow) - Coordinating with teammates
- [AI Agent Integration](/packs/software-delivery/agents/ai-agent-integration) - Deep dive on AI workflows
- [Troubleshooting](/packs/software-delivery/setup/troubleshooting) - Common issues and solutions
