...
<Aside type="caution">
  When triggers fire: commit work, push branch, document progress in WU notes, then clear context
  and resume fresh.
</Aside>
...
When working within an [initiative](/packs/software-delivery/advanced/initiatives), sizing changes because the orchestrator manages wave-based execution with checkpoints between waves.
...
- Each WU in an initiative follows standard sizing thresholds
...
- [Work Units](/packs/software-delivery/concepts/work-units) -- WU structure and lifecycle
- [Team Workflow](/packs/software-delivery/workflows/team-workflow) -- Collaborative sizing
