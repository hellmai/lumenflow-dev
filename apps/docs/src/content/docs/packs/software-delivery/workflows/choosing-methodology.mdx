...
- [Migrating Methodology](/packs/software-delivery/workflows/migrating-methodology) - Step-by-step migration paths
...
- [Team Workflow](/packs/software-delivery/workflows/team-workflow) - Multi-developer patterns
