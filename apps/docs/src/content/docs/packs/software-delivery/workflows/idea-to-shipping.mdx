...
<Aside type="note" title="Software Delivery Pack workflow">
  This end-to-end guide uses the [Software Delivery Pack](/packs/software-delivery/overview). Every command shown
  routes through the LumenFlow [kernel](/kernel/runtime) for scope enforcement, policy evaluation,
...
<Aside type="caution" title="create-next-app in Non-Empty Directories">
...
| `workspace.yaml`            | Configure lanes, gates | Lane definitions, gate commands to run       |
...
| `workspace.yaml`      | Understood lanes, ran correct gate commands     |
...
- [Work Units](/packs/software-delivery/concepts/work-units) — Deep dive on WU structure and lifecycle
- [Initiatives](/packs/software-delivery/advanced/initiatives) — Coordinating multi-phase projects
- [AI Agent Integration](/packs/software-delivery/agents/ai-agent-integration) — Advanced agent patterns
- [A Day with LumenFlow](/packs/software-delivery/workflows/a-day-with-lumenflow) — Daily workflow walkthrough
