...
<Aside type="note" title="Software Delivery Pack workflow">
  This end-to-end guide uses the [Software Delivery Pack](/packs/software-delivery/overview). Every
  command shown routes through the LumenFlow [kernel](/kernel/runtime) for scope enforcement, policy
