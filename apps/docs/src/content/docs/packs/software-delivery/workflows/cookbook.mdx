...
| -------- | ------------------------------- | --------------------------------- |
| **P0**   | Production down, data loss      | Drop everything. Fix immediately. |
| **P1**   | Major feature broken, no hotfix | Fix within current session.       |
| **P2**   | Degraded experience, workaround | Create Bug WU, schedule next.     |
| **P3**   | Minor issue, cosmetic           | Create Bug WU, add to backlog.    |
...
- [A Day with LumenFlow](/packs/software-delivery/workflows/a-day-with-lumenflow) - Complete workflow walkthrough
- [Troubleshooting](/packs/software-delivery/setup/troubleshooting) - More detailed solutions
