...
3. Locks older than 2 hours with a dead PID will auto-clear on the next `wu:claim` attempt.
...
See [Agent Safety](/reference/agent-safety) for the full enforcement architecture.
...
3. **Ask for help:**
   - [GitHub Discussions](https://github.com/hellmai/lumenflow-dev/discussions)
