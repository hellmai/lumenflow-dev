...
LumenFlow is an open-source runtime kernel for AI agents. It controls what agents can do, proves what they did, and enforces policies they can't bypass. Like an OS kernel mediates between programs and hardware, LumenFlow mediates between agents and everything they touch — filesystem, git, APIs, databases, cloud services.

### Is LumenFlow a project management tool?

No. LumenFlow is an agent governance kernel with pluggable domain packs. The Software Delivery Pack (pack #1) adds WU lifecycle, lanes, gates, and worktree isolation for software teams. You can build packs for any domain.
...
### Is LumenFlow open source?

Yes. LumenFlow is licensed under AGPL v3 (kernel, runtime, packs, surfaces) and Apache 2.0 (Control Plane SDK). See [Licensing](/legal/licensing/) for details.

### Is LumenFlow free?

Yes. LumenFlow is free and open source. Commercial licenses are available for organizations that cannot comply with AGPL v3. A hosted control plane for fleet management is planned. See [Licensing](/legal/licensing/).
...
### See [Troubleshooting Guide](/packs/software-delivery/setup/troubleshooting)
...
- [GitHub Discussions](https://github.com/hellmai/lumenflow-dev/discussions) - Ask the community
