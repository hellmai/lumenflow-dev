...
<Aside>
  With the GitHub App only approach, you manage WU YAML files manually. Consider upgrading to the
  CLI for automated worktree management, metrics, and agent coordination features.
</Aside>
