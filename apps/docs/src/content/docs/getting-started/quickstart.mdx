...
4. **Create your first Work Unit**
   ...
   npx wu-create --title "Add login page" --lane "Experience: UI"
   # Or with explicit ID: npx wu-create --id WU-001 --title "Add login page" --lane "Experience: UI"
   ```

   This creates a minimal WU. Edit the YAML file to add details:
   ...
   <Aside type="tip">
     Start simple. Add `--type`, `--description`, `--acceptance`, and other flags as needed, or edit
     the YAML directly.
   </Aside>
