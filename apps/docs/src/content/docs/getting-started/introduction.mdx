...
| CLI commands work everywhere                          | [MCP server](/packs/software-delivery/agents/mcp-setup) for programmatic access |
...
- [Get Started (Humans)](/getting-started/manual-quickstart) — Step-by-step setup for developers
