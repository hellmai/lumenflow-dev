---
title: Manual Quickstart (Humans)
description: Step-by-step setup when you want to run LumenFlow manually
---

import { Steps, Aside, Badge } from '@astrojs/starlight/components';

<Aside type="tip" title="Using an AI Agent?">
  Give your agent the [Agent Quickstart](/getting-started/quickstart/) link instead. This page is
  the manual, human-run walkthrough.
</Aside>
...
<Aside type="danger" title="DO NOT">
  Do not manually create these files. Do not edit `workspace.yaml` by hand. Use CLI commands to
...
- [Work Units](/packs/software-delivery/concepts/work-units) — Understand WU lifecycle and fields
- [Gates](/packs/software-delivery/concepts/gates) — Learn about quality gates
