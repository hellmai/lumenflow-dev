...
<Aside type="note" title="Pack architecture">
  LumenFlow's [kernel](/kernel/runtime) is domain-agnostic — it provides scope enforcement, policy
...
<CardGrid>
  ...
  <Card title="Gates" icon="approve-check">
    ...
    more →](/packs/software-delivery/concepts/gates)
  </Card>
  <Card title="Memory Layer" icon="puzzle">
    ...
    more →](/packs/software-delivery/concepts/memory)
  </Card>
</CardGrid>
...
See the [Policy Engine](/kernel/policy-engine) for how these are evaluated.
...
- **Concepts** — [Work Units](/packs/software-delivery/concepts/work-units), [Lanes](/packs/software-delivery/concepts/lanes), [Gates](/packs/software-delivery/concepts/gates), [Memory](/packs/software-delivery/concepts/memory)
- **Workflows** — [A Day with LumenFlow](/packs/software-delivery/workflows/a-day-with-lumenflow), [Solo](/packs/software-delivery/workflows/solo-workflow), [Team](/packs/software-delivery/workflows/team-workflow)
- **Advanced** — [Initiatives](/packs/software-delivery/advanced/initiatives), [Flow Metrics](/packs/software-delivery/advanced/metrics), [Custom Skills](/packs/software-delivery/advanced/custom-skills)
- **Build your own** — [Create a Pack](/packs/software-delivery/setup/create-a-pack)
