...
<Aside type="note" title="Pack architecture">
  ...
  Delivery Pack is the first production pack; others (compliance-audit, infra-ops, security-ops) are
  planned.
</Aside>
...
Scrum batches work into time-boxed sprints. The Software Delivery Pack flows work through **parallel lanes** — each with a WIP limit (typically 1 for solo work, 3 for teams). Work flows continuously instead of waiting for sprint boundaries.
