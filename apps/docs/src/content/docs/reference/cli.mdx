...
| Other           | [`backlog:prune`](#backlogprune), [`file:delete`](#filedelete), [`file:edit`](#fileedit), [`file:read`](#fileread), [`file:write`](#filewrite), [`init:plan`](#initplan), [`state:bootstrap`](#statebootstrap)                                                                                                                                                                                                                                                                                                             |
