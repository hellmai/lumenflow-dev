...
The LumenFlow CLI provides [Software Delivery Pack](/pack/overview) commands for managing Work Units, memory, initiatives, and more. These commands route through the [kernel](/concepts/kernel) for scope enforcement, policy evaluation, and evidence recording.
...
| Category            | Commands                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Gates & Quality     | [`gates`](#gates), [`gates:docs`](#gatesdocs), [`lane:edit`](#laneedit), [`lane:health`](#lanehealth), [`lane:lock`](#lanelock), [`lane:setup`](#lanesetup), [`lane:status`](#lanestatus), [`lane:suggest`](#lanesuggest), [`lane:validate`](#lanevalidate), [`lumenflow-gates`](#lumenflow-gates), [`lumenflow-validate`](#lumenflow-validate), [`validate`](#validate)                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Initiatives         | [`initiative:add-wu`](#initiativeadd-wu), [`initiative:bulk-assign-wus`](#initiativebulk-assign-wus), [`initiative:create`](#initiativecreate), [`initiative:edit`](#initiativeedit), [`initiative:list`](#initiativelist), [`initiative:plan`](#initiativeplan), [`initiative:remove-wu`](#initiativeremove-wu), [`initiative:status`](#initiativestatus)                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Metrics & Flow      | [`flow:bottlenecks`](#flowbottlenecks), [`flow:report`](#flowreport), [`lumenflow:metrics`](#lumenflowmetrics), [`metrics`](#metrics), [`metrics:snapshot`](#metricssnapshot)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Packs               | [`pack:hash`](#packhash), [`pack:install`](#packinstall), [`pack:publish`](#packpublish), [`pack:scaffold`](#packscaffold), [`pack:search`](#packsearch), [`pack:validate`](#packvalidate)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Plans               | [`init:plan`](#initplan), [`plan:create`](#plancreate), [`plan:edit`](#planedit), [`plan:link`](#planlink), [`plan:promote`](#planpromote)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Setup & Development | [`backlog:prune`](#backlogprune), [`config:get`](#configget), [`config:set`](#configset), [`docs:sync`](#docssync), [`file:delete`](#filedelete), [`file:edit`](#fileedit), [`file:read`](#fileread), [`file:write`](#filewrite), [`git:branch`](#gitbranch), [`git:diff`](#gitdiff), [`git:log`](#gitlog), [`git:status`](#gitstatus), [`lumenflow`](#lumenflow), [`lumenflow-init`](#lumenflow-init), [`lumenflow:commands`](#lumenflowcommands), [`lumenflow:docs-sync`](#lumenflowdocs-sync), [`lumenflow:doctor`](#lumenflowdoctor), [`lumenflow:integrate`](#lumenflowintegrate), [`lumenflow:release`](#lumenflowrelease), [`lumenflow:sync-templates`](#lumenflowsync-templates), [`lumenflow:upgrade`](#lumenflowupgrade), [`sync:templates`](#synctemplates), [`workspace:init`](#workspaceinit) |
...
Run docs-only quality gates (alias)

(pnpm script alias for `pnpm gates --docs-only`)
...
Run all quality gates (alias)

```bash
pnpm lumenflow-gates
```

### lumenflow-validate

Run validation checks (alias)
...
| `--decay`                     | Run decay-based archival (archive stale nodes below threshold). Uses config from .lumenflow.config.yaml or defaults. | No       |
...
Claim a task directly through the [kernel runtime](/concepts/kernel), bypassing the CLI's WU layer.

<Aside type="note" title="Kernel primitive vs CLI command">
  `task:claim` operates at the kernel level — it claims a **task** (the kernel's unit of work)
  rather than a **WU** (the Software Delivery Pack's wrapper). Use `wu:claim` for normal workflow;
  use `task:claim` only when you need direct kernel interaction, such as building custom packs or
  testing kernel behavior.
</Aside>

```bash
pnpm task:claim --task-id <taskId> --by <identity> --session-id <sessionId>
```
...
| Flag                             | Description                                        | Required |
| -------------------------------- | -------------------------------------------------- | -------- |
| `--task-id &lt;taskId&gt;`       | Task ID to claim (e.g., WU-1772)                   | Yes      |
| `--by &lt;identity&gt;`          | Actor identity for the claim (e.g., tom@hellm.ai)  | Yes      |
| `--session-id &lt;sessionId&gt;` | Session ID for runtime event correlation           | Yes      |
| `--timestamp &lt;iso8601&gt;`    | Optional ISO-8601 timestamp override               | No       |
| `--domain-data &lt;json&gt;`     | Optional JSON payload for domain-specific metadata | No       |
| `--workspace-root &lt;path&gt;`  | Workspace root directory (default: `.`)            | No       |

Related kernel commands: `task:create`, `task:complete`, `task:block`, `task:unblock`, `task:inspect`, `tool:execute`.

## Packs

### pack:hash

Generate content hash for a pack
...
Validate pack manifest and structure
...
Safely update .lumenflow.config.yaml via micro-worktree
...
Sync agent docs (for upgrades) (alias)

(pnpm script alias for `pnpm lumenflow:docs-sync`)
...
Initialize LumenFlow in a project (alias)
...
Sync templates to project (alias)
...
| Flag                | Description                                        |
| ------------------- | -------------------------------------------------- |
| `--id <wuId>`       | Work Unit ID                                       |
| `--client <client>` | Target client (claude-code, codex-cli, gemini-cli) |
...
| ----------------------- | ----------------------------------------------------- |
| `--id <wuId>`           | Work Unit ID                                          |
| `--skip-gates`          | Skip gates check (requires `--reason` and `--fix-wu`) |
| `--reason <text>`       | Reason for skipping gates                             |
| `--fix-wu <wuId>`       | WU that will fix skipped gate failures                |
| `--no-remove`           | Skip worktree removal after merge                     |
| `--no-merge`            | Skip auto-merge (leave branch)                        |
| `--delete-branch`       | Delete lane branch after merge                        |
| `--no-auto`             | Skip auto-updating YAML/backlog                       |
| `--override-owner`      | Override ownership check (requires `--reason`)        |
| `--skip-exposure-check` | Skip exposure validation                              |
| `--allow-todo`          | Allow TODO comments in code                           |
...
- [Workspace Spec](/reference/workspace-spec) – Kernel-level workspace.yaml reference
- [MCP Server](/reference/mcp) – MCP protocol reference
- [WU Schema](/reference/wu-schema) – Work Unit YAML structure
- [Kernel Runtime](/concepts/kernel) – How `task:*` commands interact with the kernel
