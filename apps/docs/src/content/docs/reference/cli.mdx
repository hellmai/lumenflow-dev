...
| `--blocked-by &lt;wuIds&gt;`        | WU IDs that block this WU (repeatable or comma-separated)                         | No       |
| `--blocks &lt;wuIds&gt;`            | WU IDs this WU blocks (repeatable or comma-separated)                             | No       |
| `--labels &lt;labels&gt;`           | Labels (repeatable or comma-separated)                                            | No       |
...
| `--code-paths &lt;paths&gt;`        | Code paths (repeatable or comma-separated)                                        | No       |
| `--test-paths-manual &lt;tests&gt;` | Manual test descriptions (repeatable or comma-separated)                          | No       |
| `--test-paths-unit &lt;paths&gt;`   | Unit test file paths (repeatable or comma-separated)                              | No       |
| `--test-paths-e2e &lt;paths&gt;`    | E2E test file paths (repeatable or comma-separated)                               | No       |
