...
<Aside type="note">
  ...
  separation allows command-by-command migration to the kernel runtime without breaking parity gates.
  The production MCP server registers both arrays via `registeredTools`.
</Aside>
