...
<Aside type="tip">
  Each package can have its own `workspace.yaml` with different gate commands, or you can use a
...
- [Gates Concepts](/packs/software-delivery/concepts/gates) - Understanding gates
