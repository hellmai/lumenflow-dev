...
Current package versions as of v2.0.0:

| Package | Version | Description |
|---------|---------|-------------|
| `@lumenflow/core` | 2.0.0 | Core WU lifecycle and state machine |
| `@lumenflow/cli` | 2.0.0 | Command-line interface |
| `@lumenflow/memory` | 2.0.0 | Session tracking and context recovery |
| `@lumenflow/agent` | 2.0.0 | Agent definitions and skill loading |
| `@lumenflow/initiatives` | 2.0.0 | Multi-phase project orchestration |
| `@lumenflow/metrics` | 1.6.0 | DORA metrics and flow analysis |
| `@lumenflow/shims` | 2.0.0 | Git and pnpm safety shims |
