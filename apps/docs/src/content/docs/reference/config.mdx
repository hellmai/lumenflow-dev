...
| `completeGuidePath`  | string | `"docs/04-operations/_framew...` |             |
| `quickRefPath`       | string | `"docs/04-operations/_framew...` |             |
| `startingPromptPath` | string | `"docs/04-operations/_framew...` |             |
| `governancePath`     | string | `"docs/04-operations/governa...` |             |
