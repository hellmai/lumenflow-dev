...
```yaml
directories:
  wu_specs: docs/04-operations/tasks/wu # Where WU YAMLs live
  backlog: docs/04-operations/tasks/backlog.md # Backlog file
  status: docs/04-operations/tasks/status.md # Status file
...
| ----------- | ------------------------------------- | ---------------------- |
| `wu_specs`  | `docs/04-operations/tasks/wu`         | WU YAML directory      |
| `backlog`   | `docs/04-operations/tasks/backlog.md` | Backlog file path      |
| `status`    | `docs/04-operations/tasks/status.md`  | Status file path       |
