...
Configure your team's approach in `workspace.yaml`:
...
1. Review the [Choosing Your Methodology](/packs/software-delivery/workflows/choosing-methodology) guide
2. Add the `methodology` section to your `workspace.yaml`
...
- [Choosing Your Methodology](/packs/software-delivery/workflows/choosing-methodology) - Detailed guide on methodology selection
- [Configuration Reference](/reference/config) - All configuration options
- [Migration Guide](/packs/software-delivery/setup/migration-guide) - Upgrading from other tools
